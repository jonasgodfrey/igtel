...
?>
    ...
    //  Get form data
        ...
        $query = "SELECT * FROM nccadmin WHERE Username='$username' AND Password='$password'";
...
<body class="hold-transition login-page" style="background-image:url('dist/img/tower2.jpg'); background-size:cover;">
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">iGoTel Web</p>
    <?php echo $message?>
