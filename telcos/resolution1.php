...
if(isset($_POST['submit'])){
  ...
  $query = "INSERT INTO resolutionreports(`Resolution`,`Status`,`DateResolved`)VALUES('$resolve','$status',now())";
                ...
                <div class="box-body">
                          ...
                          <table id="example1" class="table table-bordered table-striped">
                           ...
                           <tbody>
                            ...
                            Latitude,Longitude,FrequencyofOccurenceID FROM consumersreports";
                            ...
                            if($result->num_rows > 0){
                              while ($row = $result-> fetch_assoc()){
                                ...
                                <td>".$row['Longitude']."</td> 
                                <td>".$row['Latitude']."</td>   
                                <td><a href='javascript:;' onClick='pickRow(" . json_encode($row) . ", " . json_encode($row_main2) . "," . json_encode($row_main3) . ",". json_encode($row_main4) .",".$myId.")' data-toggle='modal' data-target='#exampleModal' class='btn btn-danger'>Resolve</a></td>                                                                                       
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
          ...
          <form role="form" action="resolution1.php" method="POST">
              <div class="box-body">
