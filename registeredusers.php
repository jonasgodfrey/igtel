  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="#"  data-toggle="modal" data-target="#exampleModalCenter"><i class="fa fa-user"></i><span>Add</span><span class="pull-right-container">
                ...
                <div class="box-body">
                          ...
                          <thead>
                           ...
                           <tbody>
                            ...
                            require('inc/db.php');
                        $sql = "SELECT ConsumerID,Username,Password,MobileNumber,OperatorID FROM consumers";
